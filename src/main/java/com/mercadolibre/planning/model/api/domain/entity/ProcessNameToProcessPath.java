...
public enum ProcessNameToProcessPath {
  ...
  WAVING(ProcessName.WAVING, List.of(TOT_MONO, NON_TOT_MONO, TOT_MULTI_BATCH, NON_TOT_MULTI_BATCH, TOT_MULTI_ORDER, NON_TOT_MULTI_ORDER)),
  PICKING(ProcessName.PICKING, List.of(TOT_MONO, NON_TOT_MONO, TOT_MULTI_BATCH, NON_TOT_MULTI_BATCH, TOT_MULTI_ORDER, NON_TOT_MULTI_ORDER)),
  PACKING(ProcessName.PACKING, List.of(TOT_MONO, NON_TOT_MONO, TOT_MULTI_ORDER, NON_TOT_MULTI_ORDER)),
  BATCH_SORTER(ProcessName.BATCH_SORTER, List.of(TOT_MULTI_BATCH, NON_TOT_MULTI_BATCH)),
  WALL_IN(ProcessName.WALL_IN, List.of(TOT_MULTI_BATCH, NON_TOT_MULTI_BATCH)),
  PACKING_WALL(ProcessName.PACKING_WALL, List.of(TOT_MULTI_BATCH, NON_TOT_MULTI_BATCH));
