...
public class InputOptimizationServiceTest {
    ...
    public void getAllInputsOptimizationTest() throws IOException {
        ...
        final List<InputOptimizationView> inputOptimizationViews = List.of(
                ...
                new InputOptimizationViewImpl(POLYVALENCE_PARAMETERS, getResourceAsString("inputoptimization/domain/polyvalence_parameters.json")),
                new InputOptimizationViewImpl(PRESENCES, getResourceAsString("inputoptimization/domain/presences.json")),
                new InputOptimizationViewImpl(SHIFT_CONTRACT_MODALITY, getResourceAsString("inputoptimization/domain/shift_contract_modality.json")),
        ...
        when(inputOptimizationRepository.findAllByWarehouseId(inputOptimizationRequest.getWarehouseId())).thenReturn(inputOptimizationViews);
    ...
    @Test
    public void getSomeInputsOptimizationWithoutFiltersTest() throws IOException {
        //GIVEN
        final List<InputOptimizationView> inputOptimizationViews = List.of(
                new InputOptimizationViewImpl(NON_SYSTEMIC_RATIO, getResourceAsString("inputoptimization/domain/non_systemic_ratio.json")),
                new InputOptimizationViewImpl(SHIFTS_PARAMETERS, getResourceAsString("inputoptimization/domain/shift_parameters.json"))
        ...
        final InputOptimizationRequest inputOptimizationRequest = new InputOptimizationRequest(WAREHOUSE_ID,
                List.of(NON_SYSTEMIC_RATIO, SHIFTS_PARAMETERS), null);
