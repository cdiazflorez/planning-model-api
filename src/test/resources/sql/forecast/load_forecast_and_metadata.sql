...
VALUES
    -- one forecast
    (1, 1, 'GLOBAL', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 10:00:00', 100, 'UNITS'),
    (2, 1, 'TOT_MONO', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 10:00:00', 70, 'UNITS'),
    (3, 1, 'TOT_MULTI_BATCH', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 10:00:00', 30, 'UNITS'),

    -- overlapping
    (4, 1, 'GLOBAL', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 100, 'UNITS'),
    (5, 1, 'TOT_MONO', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 70, 'UNITS'),
    (6, 1, 'TOT_MULTI_BATCH', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 30, 'UNITS'),

    (7, 2, 'GLOBAL', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 50, 'UNITS'),
    (8, 2, 'TOT_MONO', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 30, 'UNITS'),
    (9, 2, 'TOT_MULTI_BATCH', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 20, 'UNITS'),

    -- another forecast
    (10, 2, 'GLOBAL', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 12:00:00', 75, 'UNITS'),
    (11, 2, 'TOT_MONO', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 12:00:00', 5, 'UNITS'),
    (12, 2, 'NON_TOT_MONO', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 12:00:00', 70, 'UNITS'),

    -- from other forecasts
    (13, 3, 'GLOBAL', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 300, 'UNITS'),
    (14, 3, 'GLOBAL', 'PACKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 300, 'UNITS'),

    -- from other processes
    (15, 1, 'GLOBAL', 'PACKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 300, 'UNITS'),
    (16, 2, 'GLOBAL', 'PACKING', 'ACTIVE_WORKERS', '2022-09-08 11:00:00', 300, 'UNITS'),

    -- less than date_from
    (17, 1, 'GLOBAL', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 09:00:00', 300, 'UNITS'),
    (18, 1, 'TOT_MONO', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 09:00:00', 300, 'UNITS'),
    (19, 1, 'TOT_MULTI_BATCH', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 09:00:00', 300, 'UNITS'),

    -- greater than date_to
    (20, 2, 'GLOBAL', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 13:00:00', 300, 'UNITS'),
    (21, 2, 'TOT_MONO', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 13:00:00', 300, 'UNITS'),
    (22, 2, 'NON_TOT_MONO', 'PICKING', 'ACTIVE_WORKERS', '2022-09-08 13:00:00', 300, 'UNITS');
